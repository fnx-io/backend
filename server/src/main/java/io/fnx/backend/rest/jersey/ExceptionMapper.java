...
import io.fnx.backend.guice.validation.ValidationException;
...
public class ExceptionMapper implements javax.ws.rs.ext.ExceptionMapper<Throwable> {
    ...
    public Response toResponse(Throwable t) {
        ...
        } else if (t instanceof io.fnx.backend.service.NotFoundException) {
            return unprocessableEntity(entityNotFound((io.fnx.backend.service.NotFoundException) t));
    ...
    private ErrorResponse entityNotFound(io.fnx.backend.service.NotFoundException t) {
