...
class CmsArticleEntity {
  ...
  CmsArticleEntity.fromJson(Map<String, dynamic> json) {
    ...
    createdBy =
      ...
      new Key.fromJson(json['createdBy'])
;
    authorName =
        json['authorName']
    ;
...
;
  ...
  static List<CmsArticleEntity> listFromJson(List<dynamic> json) {
    return json == null ? new List<CmsArticleEntity>() : json.map((value) => new CmsArticleEntity.fromJson(value)).toList();
  }

  static Map<String, CmsArticleEntity> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, CmsArticleEntity>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new CmsArticleEntity.fromJson(value));
    }
    return map;
  }
}
