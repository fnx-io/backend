...
;
  ...
  static List<UpdateUserDto> listFromJson(List<dynamic> json) {
    return json == null ? new List<UpdateUserDto>() : json.map((value) => new UpdateUserDto.fromJson(value)).toList();
  }

  static Map<String, UpdateUserDto> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, UpdateUserDto>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new UpdateUserDto.fromJson(value));
    }
    return map;
  }
}
