...
/* folder */
  ...
  FileEntity.fromJson(Map<String, dynamic> json) {
    ...
    category =
      ...
      new FileCategory.fromJson(json['category'])
;
    set_ =
        json['set_']
    ;
    uploader =
      ...
      new Key.fromJson(json['uploader'])
;
  ...
  static List<FileEntity> listFromJson(List<dynamic> json) {
    return json == null ? new List<FileEntity>() : json.map((value) => new FileEntity.fromJson(value)).toList();
  }

  static Map<String, FileEntity> mapFromJson(Map<String, Map<String, dynamic>> json) {
    var map = new Map<String, FileEntity>();
    if (json != null && json.length > 0) {
      json.forEach((String key, Map<String, dynamic> value) => map[key] = new FileEntity.fromJson(value));
    }
    return map;
  }
}
